...
# speed = -570
speed = 550     #walking slow=400,quick = 520,middle=460
# speedl = -650
speedl = 450
# speedl = 600
# 512 576
...
def get_io_value():
    ...
    while True:
        ...
        #taixia:   [0]<=1500,[1]<=900
        if adc_data[0 ] < 2400 or adc_data[1] < 1600 :
            flag = False
...
#                 print("if",end=".")
               # print(io_data)
                controller.up.CDS_SetAngle(6, 532-40, servo_speed)
                controller.up.CDS_SetAngle(7, 532 + 30, servo_speed)#20230607
                #debug---20230607
#                 up.CDS_SetSpeed(1, speed)
#                 up.CDS_SetSpeed(2, -speed)
...
#                         controller.up.CDS_SetAngle(7, 532, servo_speed)  
                    if not io_data[4]:
                        ...
                        if tag_id == my_id:
                            ...
                            up.CDS_SetSpeed(1, 0)
                            up.CDS_SetSpeed(2, 0)
                            make_a_turn(1,turn_tangle+0.8)
                            time.sleep(0.4)
                        if tag_id == enemy or tag_id == 0:
                            down_tagid_enemy = down_tagid_enemy + 1 
                            print("down_67  enemy")
                            if down_tagid_enemy == 3:
 ...
 #555555555555555555                 
      ...
      #              if not io_data[4] and io_data[6] and io_data[7] and state_flag:
                    ...
                    if tag_id == my_id:
                        ...
                        make_a_turn(direction = 1,times = 1) #1.1
