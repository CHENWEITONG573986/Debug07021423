...
def build_argparser():
    ...
    args.add_argument("-m", "--model", help="Required. Path to an .xml file with a trained model.",
                      default="./model/color.xml", type=str)
    ...
    args.add_argument("--labels", help="Optional. Path to labels mapping file", default="./model/color_label.txt" ,type=str)
            ...
            for obj in res[0][0]:
                ...
                if obj[2] > args.prob_threshold:
                    ...
                    cv2.putText(frame, det_label + ' ' + str(round(obj[2] * 100, 1)) + ' %', (xmin, ymin - 7),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, color[class_id], 1)
