...
# 
controller.up.CDS_SetAngle(4, servo_r-150, servo_speed)
controller.up.CDS_SetAngle(5, servo_l+150, servo_speed)
controller.up.CDS_SetAngle(6, servo_r-100, servo_speed)
controller.up.CDS_SetAngle(7, servo_l+100, servo_speed)
time.sleep(1.0)
# 
