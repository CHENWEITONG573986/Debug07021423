...
# speed = -570
speed = 580  # walking slow=400,quick = 520,middle=460
# speedl = -650
speedl = 450
# speedl = 600
# 512 576
...
if __name__ == '__main__':
    ...
    while True:
        #
        if not io_data[3] or not io_data[2]:
            #
            break
    ...
    while True:
        try:
            ##print("flag:",flag,'-----',io_data[7],io_data[5])
            ...
            if flag:  # flag tai up tai down
                ...
                # ////////////////////////////////
                ...
                elif io_data[7] or io_data[5]:  # 倒退
                    ...
                    if not io_data[3]:
                        ...
                        while True:
                            ...
                            if not io_data[1] or (current_time - start_time) >= 3:
                                break

                        up.CDS_SetSpeed(1, 0)
                        up.CDS_SetSpeed(2, 0)
                        if io_data[7] and not io_data[6]:
                            make_a_turn(-1, 0.3)
                            time.sleep(0.2)
                        elif not io_data[7] and io_data[6]:
                            make_a_turn(1, 0.3)
                            time.sleep(0.2)
                        else:
                            time.sleep(0.2)
                        ...
                        up.CDS_SetSpeed(1, 0)
                        up.CDS_SetSpeed(2, 0)
                        if io_data[4] and not io_data[5]:
                            make_a_turn(-1, 0.3)
                            time.sleep(0.2)
                        elif not io_data[4] and io_data[5]:
                            make_a_turn(1, 0.3)
                            time.sleep(0.2)
                        else:
                            time.sleep(0.2)
#                     elif not io_data[3] or not io_data[2]:
#                         print('right or left')
#                         if not io_data[3]:
#                             up.CDS_SetSpeed(1, -speedl)
...
#                         up.CDS_SetSpeed(2, 0)
#                         time.sleep(0.2)
                    elif not io_data[1] and not io_data[0]:
                        time.sleep(0.5)
                        if tag_id == my_id:
                            down_tagid_enemy = 0
                            print("down_67_my")
                ...
                elif io_data[6] or io_data[4]:  # up jiaoluo
                    tagid_enemy = 0
                    tagid_enemy_1 = 0
                    if not io_data[3]:
                        print("up--right")
                        ...
                        if io_data[5] and not io_data[4]:
                            make_a_turn(-1, 0.25)
                            time.sleep(0.2)
                        elif not io_data[5] and io_data[4]:
                            make_a_turn(1, 0.25)
                            time.sleep(0.2)
                        else:
                            time.sleep(0.2)
                        ...
                        time.sleep(0.1)
                        # 555555555555555555
                elif not io_data[3] and io_data[1] and io_data[0]:
                    tagid_enemy = 0
                    tagid_enemy_1 = 0
                    #              if not io_data[3] and io_data[1] and io_data[0] and state_flag:
                    print('---right')
                    up.CDS_SetSpeed(1, -speedl)
                    up.CDS_SetSpeed(2, (speedl + 100))
                    time.sleep(0.4)
                    ...
                    up.CDS_SetSpeed(2, 0)
                    time.sleep(0.2)
                elif not io_data[2] and io_data[1] and io_data[0]:
                    tagid_enemy = 0
                    tagid_enemy_1 = 0
                    print('---left')
                    up.CDS_SetSpeed(1, -(speedl + 100))
                    ...
                    up.CDS_SetSpeed(2, 0)
                    time.sleep(0.2)
                elif not io_data[1] and not io_data[0]:  # er-wei-ma jiance
                    print('io_6-io_7')
                    time.sleep(0.5)
                    tagid_enemy = 0
                    if tag_id == my_id:
                    ...
                    #                             up.CDS_SetSpeed(2, -crush_speed)
                        ...
                        while True:
                            ...
                            if io_data[1] or io_data[0] or io_data[5] or io_data[7]:
                                break
                        up.CDS_SetSpeed(1, -500)
                        up.CDS_SetSpeed(2, 500)
                        time.sleep(0.8)
            ...
            # flag = False (down-plat)
                ...
                if not io_data[1] and io_data[0] and io_data[3] and io_data[2]:
                    print("T:", io_data[1], io_data[0], io_data[3], io_data[2])
                    # go-up to plat.
                    # time.sleep(0.6)
                    #                     move(1,0.8)
                ...
                elif (not io_data[1] and not io_data[0]) and (io_data[3] and io_data[2]):  # zhong,jian
                    print("weilan")
                    time.sleep(0.2)
                    # 1=turn right, 2=time
                    make_a_turn(1, 1.0)
                ...
                elif (not io_data[1] and not io_data[0]) and (not io_data[3] or not io_data[2]):
                    # print("")
                    if io_data[3]:  # turn right ???
                        up.CDS_SetSpeed(1, -400)
                        up.CDS_SetSpeed(2, 400)
                        time.sleep(1.0)
                        up.CDS_SetSpeed(1, 0)
                ...
                elif not io_data[3] and not io_data[2]:
